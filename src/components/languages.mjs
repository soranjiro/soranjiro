export function renderLanguages(data) {
  ...
  return `
    ...
    <style>
      ...
      .lang-indicator { width: 3px; height: 16px; border-radius: 2px; flex-shrink: 0; }
      .lang-name { width: 110px; font-weight: 500; color: var(--text-primary); white-space: nowrap; font-size: 12px; }
      .lang-bar-track { flex: 1; height: 3px; background: var(--ring-track); border-radius: 2px; overflow: hidden; }
      .lang-bar-fill { height: 100%; border-radius: 2px; transition: width 0.8s var(--ease-out); }
